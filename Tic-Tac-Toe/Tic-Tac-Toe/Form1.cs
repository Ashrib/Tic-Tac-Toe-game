...
namespace Tic_Tac_Toe
{
    public partial class Form1 : Form
    {
        ...
        public void check()
        {
            ...
            {
                MessageBox.Show("X Win this match.","GAME OVER",MessageBoxButtons.OK, MessageBoxIcon.Information);
                temizle();
            }
            else if (button1.Text == "O" && button2.Text == "O" && button3.Text == "O")
            {
                MessageBox.Show("O Win this match.", "GAME OVER", MessageBoxButtons.OK, MessageBoxIcon.Information);
                temizle();
            }
